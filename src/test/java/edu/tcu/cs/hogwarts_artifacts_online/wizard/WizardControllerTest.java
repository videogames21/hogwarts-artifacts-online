...
public class WizardControllerTest {
    ...
    void testAddWizardSuccess() throws Exception {
        WizardDto wizardDto = new WizardDto(1, "Hermione Granger", 0);
    ...
    @Test
    void testUpdateWizardErrorWithNonExistantId() throws Exception {
        //Given
    ...
    void testAssignArtifactErrorWithNonExistentArtifactId() throws Exception {
        //Given
        doThrow(new ObjectNotFoundException("artifact", "1250808603744924199")).when(this.wizardService).assignArtifact(2,"1250808603744924199");
        //When and Then
        this.mockMvc.perform(put(this.baseURL + "/wizards/2/artifacts/1250808603744924199").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
                .andExpect(jsonPath("$.message").value("Could not find artifact with Id 1250808603744924199 :("))
                .andExpect(jsonPath("$.data").isEmpty());
    }
